...
export default function Election() {
  ...
  return (
    <div className="space-y-8">
      {/* Hero */}
      <div className="rounded-2xl border border-gray-200/60 dark:border-gray-700/60 bg-gradient-to-br from-emerald-50 to-teal-50 dark:from-emerald-900/20 dark:to-teal-900/20 p-6 sm:p-8">
...
Election.layout = (page) => {
  const header = (
    <div className="flex items-center gap-3">
      <div className="p-2 rounded-xl bg-gradient-to-br from-emerald-600 to-teal-600 text-white shadow">
        <CalendarDays className="h-6 w-6" />
      </div>
      <div>
        <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white">Student Elections</h2>
        <p className="text-sm text-gray-500 dark:text-gray-400">Upcoming, ongoing, and finalized elections</p>
      </div>
    </div>
  );
